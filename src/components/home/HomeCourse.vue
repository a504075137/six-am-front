...
<div class="homeCourse">
    ...
    <div class="course">
        <div class="singleContent" @click="clickCourse(item)" v-for="item in courseList" :key="item.id">
            ...
            <div class="courseContent">
                ...
                <div class="bottom">
                    ...
                    <div class="total">{{item.styleTotal}}人学习</div>                    
                </div>
            </div>
        </div>
    </div>
    <div v-if="changeList" class="refresh">换一换</div>
</div>
</template>
...
export default {
    name: 'homecourse',
    props: ['courseList', 'title', 'changeList'],
    methods: {
        clickCourse (item) {
            if (item.toPurcase) item.toPurcase()
        }
    }
}
</script>
